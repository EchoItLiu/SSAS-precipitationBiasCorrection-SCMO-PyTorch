...
class ED_DCNN(nn.Module):
    def __init__(self, ED_out_channel):
        super(ED_DCNN, self).__init__()
        # Dconv1 has noisy
        self.offset1 = ConvOffset2D(256)
        self.conv1 = BasicConv2d(256, ED_out_channel, 3, bn=True, padding=1)
        # Dconv2
        self.offset2 = ConvOffset2D(64)
        self.conv2 = BasicConv2d(64, ED_out_channel, 3, bn=True, padding=1)
